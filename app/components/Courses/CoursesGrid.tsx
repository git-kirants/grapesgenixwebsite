...
const CoursesGrid: React.FC = () => {
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl mx-4 sm:mx-auto p-4 sm:p-6 relative" style={{ height: '90vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="mt-6 flex justify-center">
        <button
          onClick={closeWidget}
          className="px-12 py-3 rounded-lg bg-[#6b3fa0] hover:bg-[#5b329b] text-white transition-all duration-300"
        >
          Close
        </button>
      </div>
